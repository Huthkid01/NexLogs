-- Parse buyer copy items stored with <<<ITEM>>> delimiter (supports multi-line details)
...
GRANT EXECUTE ON FUNCTION parse_product_detail_items(TEXT) TO authenticated;
