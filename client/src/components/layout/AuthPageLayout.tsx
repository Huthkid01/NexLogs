...
export function AuthPageLayout({ children, title, description }: AuthPageLayoutProps) {
  return (
    <div className="w-full lg:grid lg:min-h-[calc(100dvh-52px)] lg:flex-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)]">
      <div className="flex min-h-screen-safe w-full items-center justify-center px-4 py-12 sm:py-14 lg:min-h-[calc(100dvh-52px)] lg:justify-start lg:bg-white lg:px-16 lg:py-10 dark:lg:bg-dm-bg xl:px-24">
