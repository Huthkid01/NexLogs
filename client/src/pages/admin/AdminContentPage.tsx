        ...
        <CardContent className="space-y-5">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <Input id="support-tutorial-title" value={draft.support.tutorialTitle} onChange={(e) => setDraft({ ...draft, support: { ...draft.support, tutorialTitle: e.target.value } })} />
            </div>
            <div>
              <Label htmlFor="support-tutorial-intro">Tutorial Section Intro</Label>
              <Input id="support-tutorial-intro" value={draft.support.tutorialIntro} onChange={(e) => setDraft({ ...draft, support: { ...draft.support, tutorialIntro: e.target.value } })} />
            </div>
          </div>

          <div className="grid gap-4 lg:grid-cols-3">
            {draft.support.tutorials.map((tutorial, index) => (
              <div key={`tutorial-${index}`} className="space-y-3 rounded-lg border border-border p-4">
                <div>
                  <Label htmlFor={`tutorial-title-${index}`}>Tutorial Title {index + 1}</Label>
                  <Input
                    id={`tutorial-title-${index}`}
                    ...
                    onChange={(e) =>
                      setDraft({
                        ...
                        support: {
                          ...draft.support,
                          tutorials: draft.support.tutorials.map((supportTutorial, tutorialIndex) => (
                            tutorialIndex === index ? { ...supportTutorial, title: e.target.value } : supportTutorial
                          )),
                        },
                      })}
                  />
                ...
                <div>
                  <Label htmlFor={`tutorial-description-${index}`}>Tutorial Description {index + 1}</Label>
                  <Textarea
                    id={`tutorial-description-${index}`}
                    ...
                    onChange={(e) =>
                      setDraft({
                        ...
                        support: {
                          ...draft.support,
                          tutorials: draft.support.tutorials.map((supportTutorial, tutorialIndex) => (
                            tutorialIndex === index ? { ...supportTutorial, description: e.target.value } : supportTutorial
                          )),
                        },
                      })}
                  />
                ...
                <div>
                  <Label htmlFor={`tutorial-label-${index}`}>Video Label {index + 1}</Label>
                  <Input
                    id={`tutorial-label-${index}`}
                    ...
                    onChange={(e) =>
                      setDraft({
                        ...
                        support: {
                          ...draft.support,
                          tutorials: draft.support.tutorials.map((supportTutorial, tutorialIndex) => (
                            tutorialIndex === index ? { ...supportTutorial, label: e.target.value } : supportTutorial
                          )),
                        },
                      })}
                  />
